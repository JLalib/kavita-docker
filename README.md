...
2. **Volúmenes persistentes**:
   - `/config`: Configuración de Kavita
...
2. **Agregar contenido a la librería**
   ...
   - Formatos soportados: Manga/Cómics: CBR, CBZ, ZIP, RAR, RAR5, 7Z | Webtoons: archivos imagen en carpeta | Libros: EPUB, PDF
   - Estructura recomendada:
     ...
     └── Books/
         └── [Libro Nombre].epub
     ```
   - Ve a Settings → Library → Scan now (Kavita detecta e indexa automático)
